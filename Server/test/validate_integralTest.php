...
class validate_integralTest extends PHPUnit_Framework_TestCase
{
     ...
     */
    function testvalidateIntegralTest($data)
    {
        $session = $data['session'];
        $flow = $data['data'];
        ...
        $out = request_by_curl('validate/integral', $data);
        $this->assertArrayHasKey('bonus', $out['data']);
    }
}
